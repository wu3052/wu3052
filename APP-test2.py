...
with st.sidebar:
    ...
    shakeout_ma_val = st.number_input("站上目標 MA 數值 (策略8)", min_value=1, max_value=240, value=20, help="對應圖中的洗盤後出量突破進場點")
...
st.caption("支援 8 大模組組合篩選、洗盤後出量突破 MA 第一天偵測、首根漲停與 VCP 形態標記。")
st.divider()
